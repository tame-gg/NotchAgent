// notchagent-opencode-plugin — auto-generated by NotchAgent
// version: v4
// OpenCode event forwarding + terminal env injection + permission/question handling
import { connect } from "net";
import { getuid } from "process";

const SOCKET = `/tmp/notchagent-${getuid()}.sock`;
...
const BRIDGE_PATH = require("path").join(require("os").homedir(), ".notchagent", "notchagent-bridge");
...
export default {
  ...
  server: async ({ client, serverUrl }) => {
    ...
    // While pending, suppress non-lifecycle events to prevent NotchAgent's
    ...
    return {
      "event": async ({ event }) => {
        ...
        // always flow through so NotchAgent can dismiss the stale approval/question card.
        ...
        // NotchAgent's "answered externally" heuristic, which drains the pending request
