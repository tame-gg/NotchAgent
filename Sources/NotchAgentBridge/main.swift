// ============================================================
// notchagent-bridge — Native Claude Code hook event forwarder
// ============================================================
...
// • NOTCHAGENT_SKIP env var support
// • Debug logging (NOTCHAGENT_DEBUG)
// ============================================================
...
func debugLog(_ message: String) {
    guard ProcessInfo.processInfo.environment["NOTCHAGENT_DEBUG"] != nil else { return }
    let ts = ISO8601DateFormatter().string(from: Date())
    let line = "[\(ts)] \(message)\n"
    let path = "/tmp/notchagent-bridge.log"
...
// Quick exit: skip if NOTCHAGENT_SKIP is set
guard env["NOTCHAGENT_SKIP"] == nil else { exit(0) }
